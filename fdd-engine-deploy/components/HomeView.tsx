...
// components/HomeView.tsx — the whole of the home page's UI.
//
// It lived at app/page.tsx until Jul 28. The problem with that: a file marked
// "use client" CANNOT export `metadata`, so the home page — the one URL every ad,
// every business card and every share link points at — was the only significant
// page on the site with no self-referencing canonical, and there was no way to
// add one without this split. /sample and /playbook already had theirs.
//
// So app/page.tsx is now a six-line server shell that owns the metadata, and
// every interactive thing lives here. Nothing about the rendering changed; this
